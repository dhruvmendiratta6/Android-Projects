...
//    TODO
//    Add fetchEarthquakedata() funcionality
//    make inner Async class in mainActivity
//    make getPostExecute() return arrayList or make updateUi() method
//    handle exceptions
//    make arraylist using List<EarthQuake> earthquakes = new ArrayList<EarthQuake>();
